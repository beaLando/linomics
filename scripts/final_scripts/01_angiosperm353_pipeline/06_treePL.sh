# NUCLEAR PHYLOGENY DATING w/ TREEPL BASED ON SUPERMATRIX AND ASTRAL TREEs
...
## NB2: 
## configuration files should be in data folder, but I added them to treePL scripts folder for upload to github
