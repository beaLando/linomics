...
#SBATCH --job-name=gtrg_beast_supermx_empty
#SBATCH --get-user-env
#SBATCH -p light
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/gtrgModel5_beast_supermxCorr_empty_%A_%a.out
#SBATCH --error=logs/gtrgModel5_beast_supermxCorr_empty_%A_%a.err
...
beast -threads 16 beast_analysis/run_empty_superMX5.xml
#beast -threads 16 beast_analysis/run_superMX5.xml
